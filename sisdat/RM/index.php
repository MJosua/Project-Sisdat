		...
		<div class="menu"><div class="sticky">
			<div class="login">
				<form method="post" action="../logindulu.php">	
				 <h3> Ingin masukkan warteg favorit kamu ? </h3>
				<button style="margin-left:15;  width:145; margin-bottom:10px;" type="submit" value="Login">Login <i class='fas fa-sign-in-alt'></i></button>
				</form>
				<form method="post" action="../register.php">	
				<a href="../DataRM.php"><button style="margin-left:15; width:145;" >Register </i></button></a>
				</form>
			</div>
